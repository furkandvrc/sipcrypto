...
abstract class AppColors {
  static Color primary = const Color(0xff051745);
  static Color primaryContainer = const Color(0xff415AA8);
  static Color secondary = const Color(0xff48d6d2);
  static Color appBarColor = const Color(0xff051745);
  static Color onAppBarColor = const Color(0xff051745);
  ...
  static Color text = const Color(0x00000000);
  static Color secondaryText = const Color(0xff676767);
  static Color tick = const Color(0xff00b894);
